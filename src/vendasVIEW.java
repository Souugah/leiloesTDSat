...
public class vendasVIEW extends javax.swing.JFrame {
    ...
    private void preencherTabela() {
                ...
                List<ProdutosDTO> listaProdutosVendidos = produtosDAO.getProdutosVendidos();
                ...
                for (ProdutosDTO p : listaProdutosVendidos) { //em cada volta do laço for, o mesmo adiciona uma dado(empresa) dentro do objeto c
    ...
    public vendasVIEW() {
        initComponents();
        setTitle("Tabela Produtos Vendidos");
        preencherTabela();
        geraAcessibilidade();
